...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Language', fields ['region_code']
        db.delete_unique(u'lex_language', ['region_code'])

        # Removing unique constraint on 'Language', fields ['lang_code']
        db.delete_unique(u'lex_language', ['lang_code'])

        # Adding field 'Language.id'
        db.add_column(u'lex_language', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)


        # Changing field 'Language.lang_code'
        db.alter_column(u'lex_language', 'lang_code', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Language.region_code'
        db.alter_column(u'lex_language', 'region_code', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):
        # Deleting field 'Language.id'
        db.delete_column(u'lex_language', u'id')


        # Changing field 'Language.lang_code'
        db.alter_column(u'lex_language', 'lang_code', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True))
        # Adding unique constraint on 'Language', fields ['lang_code']
        db.create_unique(u'lex_language', ['lang_code'])


        # Changing field 'Language.region_code'
        db.alter_column(u'lex_language', 'region_code', self.gf('django.db.models.fields.CharField')(max_length=3, primary_key=True))
        # Adding unique constraint on 'Language', fields ['region_code']
        db.create_unique(u'lex_language', ['region_code'])
